...
# 10) функция map
map() используется для применения функции к каждому элементу итерируемого объект
...
11) abs() # возвращает мудуль числа 
abs(-3) # 3

12) continue можно делать им пропуски в циклах и ветвлениях
 напр.  настроили цикл, но если if что-то там, то continue и он пропустит данную итерацию

# написать пример


13) flag это блять что-такое
